...
.text
	...
	comparacao:
		beq $t0, $t1, fimDaComparacao #todos os números já foram comparados
		lw $t2, meuArray($t0) #movendo o valor da memória para um registrador t2
		bgt $t2, $t3, novoMaior #verifica se é maior que o maior valor já encontrado
		addi $t0, $t0, 4
		j comparacao
	novoMaior:
		move $t3, $t2
		...
		j comparacao
	fimDaComparacao:
		li $v0, 1 #impressão do valor na tela
		move $a0, $t3
		syscall
